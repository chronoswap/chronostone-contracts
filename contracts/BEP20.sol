...
contract BEP20 is Context, IBEP20, Ownable {
     ...
     * @dev Returns the bep token owner.
     */
    function getOwner() external view virtual override returns (address) {   //TODO esto debe quitarse el get antes
        return owner();
    }
     ...
     * @dev Returns the token name.
     */
    function getName() public view virtual override returns (string memory) {  //TODO esto debe quitarse el get antes
        return _name;
    }
